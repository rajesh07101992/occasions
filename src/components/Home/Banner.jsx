                      ...
                      images.map((item, i) => (
                        <div key={i} className="item w-full h-full group">
                          <div
                            ...
                            className="flex w-full max-w-full h-full h-auto relative items-center rtl:pr-[30px] ltr:pl-[30px] justify-center"
                          >
                            <div>
                              ...
                              {/* <div className="md:mb-[30px] mb-[15px]">
                                <p className="md:text-[50px] text-[20px] leading-none text-qblack md:mb-3 khmer color-white">
                                  {item.title_one}
                                </p>
                                <h1 className="md:text-[50px] text-[20px] md:w-[400px] md:leading-[66px] text-qblack font-bold khmer color-white">
                                  {item.title_two}
                                </h1>
                              </div> */}
