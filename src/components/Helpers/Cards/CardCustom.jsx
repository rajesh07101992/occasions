...
export default function CardCustom({ datas }) {
    ...
    return (
        <div className="main-wrapper-card relative">
            <div
                className="product-card-one w-full h-[400px] bg-white relative group overflow-hidden"
            ...
            >
                    ...
                    >
                        ...
                        >
                            <Image
                                ...
                                className="w-full h-full object-contain cursorPointer"
                            />
                        </Link>
                ...
                <div className="product-card-details px-[30px] pb-[30px] relative pt-2">
                    {/* add to card button */}
                    <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[65px] transition-all duration-300 ease-in-out">
                        <button
                    ...
                    <div className="bottomBlock">
                        <p className="price">
                            <span
                                ...
                                className={`main-price  font-600 text-[16px] ${offerPrice ? "line-through text-qgray" : "text-qred"
                                    }`}
                            >
                                {offerPrice ? (
                        ...
                        {datas.shop_name &&
                            <p className="shopName">
                                by <span>
                                    <Link href={`/seller-products?seller=${datas.shop_name}`}>
                                        {datas.shop_name?.charAt(0).toUpperCase() + datas.shop_name?.slice(1)}
