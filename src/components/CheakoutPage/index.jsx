        ...
        if (selectedRule) {
          if (selectPayment) {
            if (selectPayment && selectPayment === "cashOnDelivery") {
              ...
              const url = `${process.env.NEXT_PUBLIC_BASE_URL
                }user/checkout/myfatoorah-webview?token=${auth().access_token
                }&shipping_method_id=${parseInt(
                  selectedRule
                )}&shipping_address_id=${selectedShipping}&coupon=${couponCode && couponCode.code
                }&billing_address_id=${selectedBilling}&request_from=react_web&frontend_success_url=${typeof window !== "undefined" && window.location.origin
                      ...
                      <div className="form-area">
                        <form>
                          ...
                          <div className="mb-6">
                            ...
                            <div
                              className={`w-full h-[50px] border px-5 flex justify-between items-center mb-2 ${!!(errors && Object.hasOwn(errors, "country"))
                                  ? "border-qred"
                                  : "border-[#EDEDED]"
                                }`}
                            >
                        ...
                        <div className="flex flex-col space-y-3">
                          ...
                          {stripeStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "stripe"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {rezorPayStatue && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "razorpay"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {flutterWaveStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "flutterWave"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {mollieStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "mollie"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {fatoorahStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "myfatoorah"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {instaMojoStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "instamojo"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {payStackStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "paystack"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {paypalStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "paypal"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {bankPaymentStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "bankpayment"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
                          ...
                          {sslStatus && (
                            <div
                              ...
                              className={`payment-item text-center bg-[#F8F8F8] relative w-full h-[50px] font-bold text-sm text-white primary-text  flex justify-center items-center px-3 uppercase cursor-pointer ${selectPayment === "sslcommerce"
                                  ? "border-2 border-qyellow"
                                  : "border border-gray-200"
                                }`}
                            >
