...
export default function AllProductPage({ response, sellerInfo }) {
  ...
  const [subCategoriesFilter, setSubCategoriesFilter] = useState(null);
  ...
  const [selectedSubCategoryFilterItem, setSelectedSubCategoryFilterItem] = useState([]);
  ...
  //   }
  //  });
  //  setCategoriesFilter(subCatFilter);
  ...
  useEffect(() => {
    ...
    //   response.data &&
    //     response.data.categories.active_sub_categories?.length > 0 &&
    //     response.data.categories.active_sub_categories.map((item) => {
    //       return {
    //         ...item,
    //         selected: false,
    //       };
    ...
    //   response.data &&
    //     response.data.categories.length > 0 &&
    //     response.data.categories.map((varient) => {
    //       return {
    //         ...varient,
    //         active_variant_items:
    //           varient.active_variant_items &&
